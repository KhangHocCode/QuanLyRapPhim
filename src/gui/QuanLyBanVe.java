...
public class QuanLyBanVe extends JPanel implements LoadData, ResetForm {
    ...
    public QuanLyBanVe() {
        ...
        JScrollPane centerScroll = new JScrollPane(pCenter,
    ...
    private void acceptTicket() {
        ...
        if (this.selectedChairs == null || this.selectedChairs.isEmpty() || this.suatChieuDuocChon == null) {
    ...
    private void selectChair() {
        ...
        if (chairList == null || chairList.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Không tìm thấy danh sách ghế cho phòng này.", "Thông báo",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }

        int soGhe = chairList.size();
    ...
    private void handleConfirmSelectChairs(ArrayList<String> selectedChairs, JFrame chairFrame, Rap rap) {
        if (selectedChairs == null || selectedChairs.isEmpty()) {
            JOptionPane.showMessageDialog(chairFrame, "Vui lòng chọn ít nhất 1 ghế.", "Thông báo",
                    JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        ...
        if (this.selectedChairs != null)
            this.selectedChairs.clear();
        this.selectedChairs = new ArrayList<>(selectedChairs);
    }
    ...
    private boolean isGheDaDat(Ghe ghe, ArrayList<Ve> ticketList) {
        if (ghe == null || ticketList == null || ticketList.isEmpty()) {
            return false;
        }
        for (Ve ve : ticketList) {
            if (ve != null && ve.getGhe() != null && ve.getGhe().getMaGhe().equalsIgnoreCase(ghe.getMaGhe())) {
                return true;
            }
        }
        return false;
